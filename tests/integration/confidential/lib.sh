...
setup_offline_fs_kbc_aa_files_in_guest() {
        add_kernel_params "agent.aa_kbc_params=offline_fs_kbc::null agent.rest_api=all"
        cp_to_guest_img "etc" "${SHARED_FIXTURES_DIR}/aa/offline-fs-kbc/aa-offline_fs_kbc-resources.json"
}
